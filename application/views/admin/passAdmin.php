<nav class="navbar navbar-expand-lg navbar-light ddn-bg-gradient">
    <div class="container p-1">
        <img src="<?= base_url('assets/'); ?>/admin/images/logo.png" alt="" style="width: 34px; height: auto;">
        <a href="<?= base_url('admin'); ?>" class="btn float-right bg-primary btn-sm text-white"><strong><i class="fas fa-home mr-1"></i>Home</strong></a>
    </div>
</nav>
<section class="mt-5">
