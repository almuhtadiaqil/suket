...
<form action="<?php echo base_url() . 'Surat/add_sk_rumahrubuh'; ?>" method="post">
	<div class="row text-left">
		<div class="col-lg-12">
			<div class="block-heading">
				<h2>FORM SURAT KETERANGAN RUMAH RUBUH</h2>
			</div>
			<!-- Isian Form 1-->
			<div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
				...
				<div class="form-row">
					<div class="form-group col-md-3">
						...
						<input type="date" name="tanggal_kejadian" class="form-control" id="tgl" required>
					</div>
					<div class="form-group col-md-3">
						<label>Waktu Kejadian</label>
						<input type="text" name="waktu_kejadian" class="form-control" id="tgl" placeholder="contoh: 07.00 WIB" required>
					</div>
					<div class="form-group col-md-6">
						<label>Kerugian</label>
						<input type="text" name="kerugian" class="form-control" id="tgl" placeholder="contoh: Rp 500.000,-" required>
					</div>
				</div>
				<div class="form-group">
