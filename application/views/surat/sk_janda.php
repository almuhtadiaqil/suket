...
<form action="<?php echo base_url() . 'Surat/add_sk_janda'; ?>" method="post">
	<div class="row text-left">
		<div class="col-lg-12">
			<div class="block-heading">
				<h2>FORM SURAT KETERANGAN JANDA</h2>
			</div>
			<!-- Isian Form 1-->
			<div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
				...
				<div class="form-row">
					...
					<div class="form-group col-md-6">
						<label for="">Status Cerai</label>
						<select name="status_cerai" id="status_cerai" class="form-control">
							<option selected>Cerai Hidup</option>
