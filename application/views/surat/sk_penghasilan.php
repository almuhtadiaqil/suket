...
<form action="<?php echo base_url() . 'Surat/add_sk_penghasilan'; ?>" method="post">
	<div class="row text-left">
		<div class="col-lg-12">
			<div class="block-heading">
				<h2>FORM SURAT KETERANGAN PENGHASILAN</h2>
			</div>
			<!-- Isian Form 1-->
			<div class="container-fluid shadow p-3  mb-3 bg-white rounded m-3">
				...
				<div class="form-row">
					<div class="form-group col-md-6">
						...
						<input type="text" class="form-control" name="penghasilan" id="penghasilan" placeholder="contoh : Rp.500.000,-" required>
					</div>
					<div class="form-group col-md-6">
						<label>Terbilang</label>
						<input type="text" class="form-control" name="terbilang" id="terbilang" placeholder="Lima Ratus Ribu" required>
					</div>
				</div>
